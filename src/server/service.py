...
class RouterManager:
    def __init__(self, object_name: str, power_level: int, pydantic_model: Type[ModifyBaseModel], database_model: Type[BaseModel], prefix: str, tags: list[str]):
