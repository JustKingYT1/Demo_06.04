...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def __setting_ui(self) -> None:
        ...
        self.tab_widget.addTab(self.user_profile, 'User profile')
        self.tab_widget.addTab(self.menu_table_views, 'Menu')

        self.menu_table_views.setFixedWidth(350)
        self.user_profile.setFixedWidth(250)
                
        self.tab_widget.hide()
        
        self.tab_widget.currentChanged.connect(lambda: self.size_expand(self.tab_widget.currentWidget()))
